...
const CampaignsDetails = ({ usercampaigns }) => {
  ...
  return (
    <div>
      {isLoading && <Loader />}
      <div className="w-full flex md:flex-row flex-col mt-10gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px] ml-[10px] sm:mt-[10px] sm:justify-between">
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                {state.owner === address ? (
                  ...
                  <p className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]">
                    {usercampaigns.length - usercampaigns.length + 1} campaigns
                  </p>
                )}
              </div>
            </div>
          ...
          <div>
            ...
            <div className="mt-[15px]">
              <p className="font-epilogue font-normal text-[16px] text-[#808191]  leading-[20px] text-justify">
                {state.description}
              </p>
            </div>
          </div>
            ...
            <div className="mt-[30px]">
              ...
              <div className="mt-[20px] p-4 bg-[#13131a] rounded-[10px]">
                <h4 className="font-epilogue font-semibold text-[14px] text-white leading-[22px]">
                  Fund it because you believe in it.
                </h4>
